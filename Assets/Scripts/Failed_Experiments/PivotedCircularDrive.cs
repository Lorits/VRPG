...
namespace Valve.VR.InteractionSystem
{
    ...
    public class PivotedCircularDrive : MonoBehaviour
    {
        public enum Axis_t
        {
            XAxis,
        ...
        [Tooltip("[Nicolai's custom drive] Have this drive act as a pivot for another object's rotation. Requires SlemGrim's RotationPivot.cs script")]
        ...
        private void UpdateGameObject()
        {
            if (rotateGameObject)
            {
                ...
                if(pivot != null)
                {
                    pivot.SetRotation(start * Quaternion.AngleAxis(outAngle, localPlaneNormal));
                } else
                {
                    Debug.Log("You forgot to add the rotation pivot script to the circular drive script. You dummy :^)");
                }
            }
        }

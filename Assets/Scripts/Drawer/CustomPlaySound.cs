...
namespace Valve.VR.InteractionSystem
{
    ...
    public class CustomPlaySound : MonoBehaviour
    {
        ...
        public void Play()
        {
            ...
            else PlayOneShotSound(currentIndex);
        }
        ...
        //-------------------------------------------------
        public AudioClip PlayOneShotSound(int fileIndex)
        {
            if (!this.audioSource.isActiveAndEnabled)
                return null;

            SetAudioSource(fileIndex);
            if (this.stopOnPlay)
                audioSource.Stop();
        ...
        //-------------------------------------------------
        public void SetAudioSource(int fileIndex)
        {
            ...
            if (this.waveFile.Length > fileIndex)
            {
                audioSource.clip = this.waveFile[fileIndex];
                clip = audioSource.clip;
